...
if (isset($_POST['login'])) 
{
    ...
    $result = mysqli_query($con, "SELECT * FROM signup WHERE email = '" . $email. "' and password = '" . md5($password) . "'");

    if ($row = mysqli_fetch_array($result)) 
	{
        $_SESSION['usr_id'] = $row['id'];
        $_SESSION['usr_name'] = $row['name'];
        header("Location: awbill.php");
    } 
    ...
    <div class="cont_centrar cent_active">
        <div class="cont_login">
            <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="loginform">
                    ...
                    <div class="cont_tabs_login">
                        <ul class="ul_tabs">
						    <li><a href="signup.php" onclick="sign_up()">SignUp</a>
							<span class="linea_bajo_nom"></span></li>
                          <li class="active"><a href="#" onclick="sign_in()">SignIn</a>
						  <span class="linea_bajo_nom"></span></li>
      ...
      <input type="text" class="input_form_sign " placeholder="NAME" name="name" />
                        ...
                        <input type="text" class="input_form_sign d_block active_inp" name="email" placeholder="Your Email" required class="form-control" />
                  

                       
                       
						
                        <input type="password" class="input_form_sign d_block active_inp" name="password" placeholder="Your Password" required class="form-control" />
