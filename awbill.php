...
<label for="field3"><span>AccountNo<span class="required">*</span></span><input type="text" class="input-field" name="accno" value="" /></label>
...
<label for="field2"><span>Phone<span class="required">*</span></span><input type="text" class="input-field" name="sphone" value="" /></label>
...
<input type="checkbox" name=others onclick="consignee(this.checked)">Disabled Consginee
