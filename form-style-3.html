...
<a href"fetc.php"><img src="print.jpg" alt="" height="100" width="100" align="right" ></a>
<div class="scrollmenu">
  <a href="#home">Dashboard</a>
  <a href="#news">Manage Clients</a>
  <a href="#contact">Manage Location</a>
    <a href="#contact">Manage AWBill</a>
	  <a href="#contact">Manage Users</a>
    <a href="#friends">Settings</a>
  <!--<ul
  <li>
    <a href="#about">Add Client</a></li>
  <li><a href="#support">Add City</a></li>
 <li><a href="#blog">Add Country</a></li>
  <li><a href="#tools">Add PaymentType</a></li>
  <li><a href="#base">Add Description</a></li>
 <li><a href="#custom">Add Pickup</a></li>
  <li><a href="#more">Add Company</a></li>
  <li><a href="#logo">Add Contact Person</a></li>
  </ul>-->
  <a href="#partners">Logout</a>
...
<label for="field3"><span>Date<span class="required">*</span></span><input type="text" class="input-field" name="date" value="" /></label>
...
<fieldset><legend>Sender Details</legend>

<label for="field3"><span>Company<span class="required">*</span></span><input type="text" class="input-field" name="scompname" value="" dis /></label>
<label for="field4"><span>Contact<span class="required">*</span></span><input type="text" class="input-field" name="sconper" value="" /></label>
<label for="field2"><span>Sender Phone<span class="required">*</span></span><input type="text" class="input-field" name="sphone" value="" /></label>
<label for="field5"><span>Flat<span class="required">*</span></span><input type="text" class="input-field" name="sflat" value="" /></label>
<label for="field6"><span>Building<span class="required">*</span></span><input type="text" class="input-field" name="sbuild" value="" /></label>
<label for="field7"><span>Street <span class="required">*</span></span><input type="text" class="input-field" name="sstreet" value="" /></label>
<label for="field8"><span>Area <span class="required">*</span></span><input type="text" class="input-field" name="sarea" value="" /></label>
<label for="field9"><label for="field4"><span>City</span><select name="scity" class="select-field">
...
<label for="field4"><span>Country</span><select name="scountry" class="select-field">
...
<label for="field3"><span>Company<span class="required">*</span></span><input type="text" class="input-field" name="ccompname" value="" /></label>
<label for="field4"><span>Contact<span class="required">*</span></span><input type="text" class="input-field" name="ccontper" value="" /></label>
<label for="field2"><span>Consignee Phone<span class="required">*</span></span><input type="text" class="input-field" name="consphone" value="" /></label>

<label for="field2"><span> Flat<span class="required">*</span></span><input type="text" class="input-field" name="cflat" value="" /></label>
<label for="field2"><span>Building<span class="required">*</span></span><input type="text" class="input-field" name="cbuilding" value="" /></label>
<label for="field2"><span>Street<span class="required">*</span></span><input type="text" class="input-field" name="cstreet" value="" /></label>
<label for="field2"><span>Area <span class="required">*</span></span><input type="text" class="input-field" name="carea" value="" /></label>
<!--<label for="field2"><span>Consignee City <span class="required">*</span></span><input type="text" class="input-field" name="ccity" value="" /></label>-->
<label for="field9"><label for="field4"><span>City</span><select name="ccity" class="select-field">
<option value="Dubai">Dubai</option>
<option value="Abudhabi">Abudhabi</option>
<option value="Sharjah">Sharjah</option>
<option value="Fujairah">Fujairah</option>
...
<label for="field2"><span> ZipCode <span class="required">*</span></span><input type="text" class="input-field" name="czip" value="" /></label>
<!--<label for="field2"><span>Consignee Country <span class="required">*</span></span><input type="text" class="input-field" name="ccountry" value="" /></label>-->
<label for="field4"><span>Country</span><select name="ccountry" class="select-field">
<option value="AF">Afghanistan</option>
	<option value="AL">Albania</option>
	<option value="DZ">Algeria</option>
	<option value="AS">American Samoa</option>
...
<!--<label for="field2"><span>Mode of Payment<span class="required">*</span></span><input type="text" class="input-field" name="mode" value="" /></label>---->
<label for="field9"><label for="field4"><span>Mode of Payment</span><select name="mode" class="select-field">
<option value="Pick-up-Cash">Pick-up-Cash</option>
<option value="COD">COD</option>
<option value="Customer">Customer</option>
</select></label>
<!--<label for="field2"><span>Special Instructions<span class="required">*</span></span><input type="text" class="input-field" name="sinst" value="" /></label>-->
<label for="field9"><label for="field4"><span>Special Instructions</span><select name="sinst" class="select-field">
<option value="/ncnd">NCND</option>
<option value="COD">COD</option>
</select></label>
<label for="field2"><span>Pieces<span class="required">*</span></span><input type="text" class="input-field" name="pieces" value="" /></label>
<label for="field2"><span>Weight<span class="required">*</span></span><input type="text" class="input-field" name="weight" value="" /></label>
<label for="field2"><span>Cash Amount<span class="required">*</span></span><input type="text" class="input-field" name="amt" value="" /></label>
<label for="field2"><span>Picked by<span class="required">*</span></span><input type="text" class="input-field" name="pickup" value="" /></label>
