...
<label for="field3"><span>Company<span class="required">*</span></span><input type="text" class="input-field" name="scompname" value=""  /></label>
<label for="field3"><span>Accont No<span class="required">*</span></span><input type="text" class="input-field" name="accno" value="" /></label>
